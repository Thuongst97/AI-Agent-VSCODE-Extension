...
class DashboardPanel {
    ...
    static createOrShow(context, authManager) {
        ...
        const panel = vscode.window.createWebviewPanel(DashboardPanel.viewType, 'Issue Dashboard', vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
    ...
    async _fetchIssues(jql) {
        ...
        try {
            ...
            const service = new atlassianService_1.AtlassianService(creds);
