...
exports.AtlassianService = void 0;
// ─── Service ─────────────────────────────────────────────────────────────────
/**
...
class AtlassianService {
    ...
    async getIssuesList(jql, maxResults = 50) {
        const data = await this.fetchJson(`${this.baseUrl}/rest/api/3/search/jql`, {
            method: 'POST',
            body: JSON.stringify({
                jql,
    ...
    async verifyCredentials() {
        const data = await this.fetchJson(`${this.baseUrl}/rest/api/3/myself`);
        return {
...
exports.AtlassianService = AtlassianService;
//# sourceMappingURL=atlassianService.js.map